...
from trainer_ms_wg import AD_Trainer
...
def get_arguments():
    ...
    parser.add_argument("--snapshot-dir", type=str, default='./snapshots/SE_GN_batchsize2_1024x512_pp_ms_me0_classbalance7_kl0.1_lr2_drop0.1_seg0.5_10',
...
def main():
    ...
    for i_iter in range(args.num_steps):
        ...
        adjust_learning_rate_D(Trainer.dis3_opt, i_iter, args)
        ...
        for sub_i in range(args.iter_size):
            ...
            with Timer("Elapsed time in update: %f"):
                loss_seg1, loss_seg2, loss_adv_target1, loss_adv_target2,loss_adv_target3, loss_me, loss_kl, pred1, pred2, pred_target1, pred_target2, val_loss = Trainer.gen_update(images, images_t, labels, labels_t, i_iter)
                ...
                loss_adv_target_value3 += loss_adv_target3 / args.iter_size
                loss_me_value = loss_me

                if args.lambda_adv_target1 > 0 and args.lambda_adv_target2 > 0:
                    loss_D1, loss_D2, loss_D3 = Trainer.dis_update(pred1, pred2, pred_target1, pred_target2, i_iter)
        ...
        print(
        '\033[1m iter = %8d/%8d \033[0m loss_seg1 = %.3f loss_seg2 = %.3f loss_me = %.3f  loss_kl = %.3f loss_adv1 = %.3f, loss_adv2 = %.3f loss_adv3 = %.3f loss_D1 = %.3f loss_D2 = %.3f,loss_D3 = %.3f val_loss=%.3f'%(i_iter, args.num_steps, loss_seg_value1, loss_seg_value2, loss_me_value, loss_kl, loss_adv_target_value1, loss_adv_target_value2, loss_adv_target_value3, loss_D_value1, loss_D_value2,  loss_D_value3,val_loss))

        # clear loss
        del loss_seg1, loss_seg2, loss_adv_target1, loss_adv_target2, loss_adv_target3, loss_me, loss_kl, val_loss
